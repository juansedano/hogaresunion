...
dialogs:{
    ...
    captions:{
        button:
        function(u){
            //return'Selecciona '+(1==u.limit?'File':'Files')
            return 'Seleccionar Imágenes';
        },
        feedback:
        function(u){
            return'Selecciona '+(1==u.limit?'file':'files')+' to upload'
        },
        feedback2:
        function(u){
            return u.length+' '+(1<u.length?' files were':' file was')+' chosen'
        },
        confirm:'Confirm',
        cancel:'Cancel',
        name:'Name',
        ...
        paste:'<div class="fileuploader-pending-loader"></div> Pasting a file, click here to cancel.',removeConfirmation:'Are you sure you want to remove this file?',
        errors:{
            filesLimit:'Only ${limit} files are allowed to be uploaded.',
            filesType:'Only ${extensions} files are allowed to be uploaded.',
            fileSize:'${name} is too large! Please selecciona a file up to ${fileMaxSize}MB.',
